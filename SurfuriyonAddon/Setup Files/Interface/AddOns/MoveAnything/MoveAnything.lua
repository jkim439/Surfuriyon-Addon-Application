...
BINDING_HEADER_MOVEANYTHING = "창이동 설정";
MA_LEFTARROW = "<";
MA_RIGHTARROW = ">";
CurrentMover = 1;

StaticPopupDialogs["MOVEANYTHING_RESET_CONFIRM"] = {
	text = "창이동을 모두 초기화 할까요?",
	button1 = TEXT"예",
	button2 = TEXT"아니오",
	OnAccept = function()
...
MoveAnything_HideList["PetActionButtonsMover"] = {
	{ "PetActionButtonsMover", function( show )
		if( show ) then
			MoveAnything_AllowExternalVisibility( PetActionBarFrame );
		else
			MoveAnything_PreventExternalVisibility( PetActionBarFrame );
		end
	end},
};
MoveAnything_HideList["PetActionButtonsVerticalMover"] = {
	{ "PetActionButtonsVerticalMover", function( show )
		if( show ) then
			MoveAnything_AllowExternalVisibility( PetActionBarFrame );
		else
			MoveAnything_PreventExternalVisibility( PetActionBarFrame );
...
MoveAnything_HideList["ShapeshiftButtonsMover"] = {
	{ "ShapeshiftButtonsMover", function( show )
		if( show ) then
			MoveAnything_AllowExternalVisibility( ShapeshiftBarFrame );
		else
			MoveAnything_PreventExternalVisibility( ShapeshiftBarFrame );
		end
	end},
};
MoveAnything_HideList["ShapeshiftButtonsVerticalMover"] = {
	{ "ShapeshiftButtonsVerticalMover", function( show )
		if( show ) then
			MoveAnything_AllowExternalVisibility( ShapeshiftBarFrame );
		else
			MoveAnything_PreventExternalVisibility( ShapeshiftBarFrame );
...
MoveAnything_HideList["MainMenuBar"] = {
	{ "MainMenuBarArtFrame", "BACKGROUND","ARTWORK","OVERLAY"},
...
MoveAnything_DefaultFrameList = {
	...
	{ "MAOptions", "MoveAnything! 설정창" },

	{ "Separator", "**** 플레이어 / 파티 프레임 ****" },
	{ "PlayerFrame", "플레이어" },
	{ "TargetFrame", "대상" },
	{ "PartyMemberFrame1", "파티원 1" },
	{ "PartyMemberFrame2", "파티원 2" },
	{ "PartyMemberFrame3", "파티원 3" },
	{ "PartyMemberFrame4", "파티원 4" },

	{ "Separator", "**** 소환수 프레임 ****" },
	{ "PetFrame", "소환수" },
	{ "PartyMemberFrame1PetFrame", "파티 소환수 1" },
	{ "PartyMemberFrame2PetFrame", "파티 소환수 2" },
	{ "PartyMemberFrame3PetFrame", "파티 소환수 3" },
	{ "PartyMemberFrame4PetFrame", "파티 소환수 4" },
	...
	{ "Separator", "**** 은행 ****" },
	{ "BankFrame", "은행원 창" },
	{ "BankBagFrame1", "은행 가방 1" },
	{ "BankBagFrame2", "은행 가방 2" },
	{ "BankBagFrame3", "은행 가방 3" },
	{ "BankBagFrame4", "은행 가방 4" },
	{ "BankBagFrame5", "은행 가방 5" },
	{ "BankBagFrame6", "은행 가방 6" },

	{ "Separator", "**** 하단바 ****" },
	{ "MainMenuBar", "하단바" },
	{ "MainMenuExpBar", "경험치바" },
	{ "MainMenuBarMaxLevelBar", "60레벨경험치바" },
	{ "ReputationWatchBar", "하단평판바" },
	{ "MainMenuBarPerformanceBarFrame", "지연 측정바" },

	{ "Separator", "**** 가방 / 작은 메뉴 ****" },
	{ "BagButtonsMover", "가방 버튼" },
	{ "BagButtonsVerticalMover", "가방 버튼 (세로)" },
	{ "MicroButtonsMover", "작은 메뉴" },
	{ "MicroButtonsVerticalMover", "작은 메뉴 (세로)" },

	{ "Separator", "**** 기본바 ****" },
	{ "BasicActionButtonsMover", "기본 행동 단축바" },
	{ "BasicActionButtonsVerticalMover", "기본 행동 단축바 (세로)" },
	{ "ActionBarUpButton", "기본 행동 단축바 위쪽 화살표"},
	{ "ActionBarDownButton", "기본 행동 단축바 아래쪽 화살표"},
	{ "PetActionButtonsMover", "소환수 행동 단축바" },
	{ "PetActionButtonsVerticalMover", "소환수 행동 단축바 (세로)" },
	{ "ShapeshiftButtonsMover", "태세 은신 오라 행동 단축바" },
	{ "ShapeshiftButtonsVerticalMover", "태세 은신 오라 행동 단축바 (세로)" },

	{ "Separator", "**** 확장 행동 단축바 ****" },
	{ "MultiBarBottomLeftButtonsMover", "좌측 하단 행동 단축바" },
	{ "MultiBarBottomLeftButtonsVerticalMover", "좌측 하단 행동 단축바 (세로)" },
	{ "MultiBarBottomRightButtonsMover", "우측 하단 행동 단축바" },
	{ "MultiBarBottomRightButtonsVerticalMover", "우측 하단 행동 단축바 (세로)" },
	{ "MultiBarRightButtonsMover", "첫번째 우측 행동 단축바" },
	{ "MultiBarRightButtonsHorizontalMover", "첫번째 우측 행동 단축바 (가로)" },
	{ "MultiBarLeftButtonsMover", "두번째 우측 행동 단축바" },
	{ "MultiBarLeftButtonsHorizontalMover", "두번째 우측 행동 단축바 (가로)" },

	{ "Separator", "**** 미니맵 / 미니맵 주변 버튼 ****" },
	{ "MinimapCluster", "미니맵" },
	{ "MinimapZoneTextButton", "미니맵 지역 정보" },
	{ "MinimapZoomIn", "확대버튼" },
	{ "MinimapZoomOut", "축소버튼" },
	{ "MiniMapMailFrame", "우편알림" },
	{ "MiniMapTrackingFrame", "탐지(약초/광물/사냥꾼 추적관련)" },
	{ "MiniMapMeetingStoneFrame", "만남의 돌" },
	{ "MiniMapBattlefieldFrame", "전장" },
	{ "GameTimeFrame", "해와달 시계" },
	{ "MinimapZoneTextButton", "미니맵 제목" },
	{ "MinimapToggleButton", "미니맵 토글 버튼" },

	{ "Separator", "**** 전장 요소 ****" },
	{ "WorldStateAlwaysUpFrame", "전장 점수 창"},
	{ "AlwaysUpFrame1", "얼라이언스 깃발"},
	{ "AlwaysUpFrame2", "호드 깃발"},

	{ "Separator", "**** 주사위 굴림 창 ****" },
	{ "GroupLootFrame1", "주사위 굴림 창 1" },
	{ "GroupLootFrame2", "주사위 굴림 창 2" },
	{ "GroupLootFrame3", "주사위 굴림 창 3" },
	{ "GroupLootFrame4", "주사위 굴림 창 4" },

	{ "Separator", "**** 여러가지 화면 아이템 ****" },
	{ "StaticPopup1", "고정 팝업 창" },
	{ "UIErrorsFrame", "UI 에러 창" },
	{ "CastingBarFrame", "캐스팅바" },
	{ "BuffFrame", "버프창" },
	{ "TemporaryEnchantFrame", "아이템버프 / 디버프창" },
	{ "TooltipMover", "툴팁" },
	{ "FramerateMover", "프레임 수치" },
	{ "DurabilityFrame", "장비 내구도" },
	{ "QuestWatchFrame", "퀘스트 수집창(목록)" },
	{ "QuestTimerFrame", "퀘스트 제한시간창" },
	{ "ComboFrame", "콤보(연계기) 포인트" },
	{ "MirrorTimer1", "호흡 / 죽은척 바" },
	...
	{ "Separator", "**** 개별 정보 창 ****" },
	{ "CharacterFrame", "캐릭터 / 소환수 / 평판 / 숙련 / 명예" },
	{ "TradeSkillFrame", "전문기술창" },
	{ "InspectFrame", "살펴보기" },
	{ "SpellBookFrame", "마법책" },
	{ "LootFrame", "루티창" },
	{ "TaxiFrame", "비행경로" },
	{ "QuestLogFrame", "퀘스트 알림창" },
	{ "MerchantFrame", "상인창" },
	{ "TradeFrame", "거래창" },
	{ "FriendsFrame", "친구 / 누구 / 길드 / 공격대" },
	{ "MacroFrame", "매크로창" },
	{ "MailFrame", "우편창" },
	{ "TalentFrame", "특성창" },
	{ "PetStableFrame", "소환수 특성창" },
	{ "AuctionFrame", "경매장" },
}
...
SLASH_MOVEANYTHING2 = "/무브";
SLASH_MOVEANYTHING3 = "/이동";
...
SLASH_UNMOVEANYTHING2 = "/언무브";
SLASH_UNMOVEANYTHING3 = "/이동중지";
...
SLASH_MOVEANYTHINGCOPYSETTINGS2 = "/무브카피";
SLASH_MOVEANYTHINGCOPYSETTINGS3 = "/이동복사";
...
SLASH_MOVEANYTHINGLISTSETTINGS2 = "/무브리스트";
SLASH_MOVEANYTHINGLISTSETTINGS3 = "/이동목록";
...
SLASH_MOVEANYTHINGDELETESETTINGS3 = "/무브델";
SLASH_MOVEANYTHINGDELETESETTINGS4 = "/이동삭제";
