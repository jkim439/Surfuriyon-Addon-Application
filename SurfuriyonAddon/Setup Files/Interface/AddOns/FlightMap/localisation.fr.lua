...
if (GetLocale() == "frFR") then
    ...
    FLIGHTMAP_WESTFALL      = "Les Marches de l'Ouest (Westfall)";
    ...
    FLIGHTMAP_STONETALON    = "Les Serres-Rocheuses (Stonealon Mts)";
    ...
    FLIGHTMAP_UNDERCITY     = "The Undercity";  -- TODO translate
    FLIGHTMAP_IRONFORGE     = "Ironforge";      -- TODO translate
    FLIGHTMAP_STORMWIND     = "Stormwind City"; -- TODO translate
    FLIGHTMAP_DARNASSUS     = "Darnassus";      -- TODO translate

    -- General strings
    FLIGHTMAP_TIMING        = "(timing)";
    FLIGHTMAP_LEVELS        = "|cff00ff00Level range: %d - %d|r";
