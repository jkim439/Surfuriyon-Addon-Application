...
if ( GetLocale() == "koKR" ) then
	TITAN_FRIENDS_MENU_TEXT = "친구정보"
	TITAN_FRIENDS_MENU_WHISPER = "귓말하기"
	TITAN_FRIENDS_MENU_INVITE = "초대하기"
	TITAN_FRIENDS_BUTTON_LABEL = "친구정보: "
	TITAN_FRIENDS_BUTTON_TEXT = "%s"..TitanUtils_GetHighlightText("/").."%s";
	TITAN_FRIENDS_TOOLTIP = "친구정보"
end 