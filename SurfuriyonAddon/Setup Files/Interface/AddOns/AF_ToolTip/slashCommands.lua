...
function aftt_commandResponse(msg)
	...
	-----------------------------------------------------------
		elseif (msg == "quest") then
			if (AF_ToolTip[aftt_localUser]["Quest"] == 1) then
				...
				DEFAULT_CHAT_FRAME:AddMessage("|cffffff00<AF>|rToolTip: Quest: Hide");
			else
				AF_ToolTip[aftt_localUser]["Quest"] = 1;
				DEFAULT_CHAT_FRAME:AddMessage("|cffffff00<AF>|rToolTip: Quest: Show");
			end
	...
	-----------------------------------------------------------
		elseif (msg == "help") then
			...
			DEFAULT_CHAT_FRAME:AddMessage("|cffffff00<AF>|r/aftt quest");
