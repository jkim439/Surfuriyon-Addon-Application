...
MozzFullWorldMap 1.01 by Shub 20060330
            ...
            for j=1, numTexturesTall do
                ...
                for k=1, numTexturesWide do
                    ...
                    if discovered[textureName] then
                        ...
                        texture:SetVertexColor(0.7,0.5,0.2) -- EMERALD
...
--[[ no need in 1.10 patch : mod by prodol
...
function WorldMapFrame_Update()
	...
	if(old_NUM_WORLDMAP_OVERLAYS) then NUM_WORLDMAP_OVERLAYS = old_NUM_WORLDMAP_OVERLAYS;
