...
if ( GetLocale() == "deDE" ) then
	...
	--Warnings
	SCT_Version_Warning= "|cff00ff00SCT WARNEND|r\n\nsind Ihre gespeicherten Variablen von einer \195\188berholten Version von SCT. Wenn Sie Störungen oder merkw\195\188rdiges Verhalten antreffen, STELLEN Sie bitte Ihre Wahlen mit der Zur\195\188ckstellentaste oder durch schreiben/sctreset zur\195\188ck";
	...
	--Animation Types
	SCT_OPTION_SELECTION1 = { name="Animation Type", tooltipText = "Which animation type to use", table = {[1] = "Vertical (Normal)",[2] = "Rainbow",[3] = "Horizontal",[4] = "Angled Down"}};
