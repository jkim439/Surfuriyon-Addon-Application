...
[1] = {name="질풍의 무기!", search="질풍의 무기로 인해", r=256/256, g=256/256, b=0/256, iscrit=1},
[2] = {name="정신 집중!", search="정신 집중 효과를 얻었습니다.", r=256/256, g=256/256, b=0/256},
[3] = {name="질풍!", search="질풍 효과를 얻었습니다.", r=128/256, g=0/256, b=0/256},
[4] = {name="번개 보호막!", search="번개 보호막 효과를 얻었습니다.", r=0/256, g=0/256, b=256/256},
[5] = {name="질풍의 도끼!", search="질풍의 도끼로 인해", r=0/256, g=128/256, b=128/256},
[6] = {name="일몰!", search="어둠의 무아지경 효과를 얻었습니다.", r=0/256, g=128/256, b=128/256}, 
[7] = {name="번개 보호막 사라짐!", search="번개 보호막 효과가 사라졌습니다", r=0/256, g=0/256, b=256/256, iscrit=1},
[8] = {name="제압!", search="(.+)%|1을;를; 공격했지만 교묘히 피했습니다.", r=256/256, g=256/256, b=0/256, iscrit=1, class={"전사"}, anitype=1},
[9] = {name="제압!", search="(.+)%|1으로;로; (.+)%|1을;를; 공격했지만 교묘히 피했습니다.", r=256/256, g=256/256, b=0/256, iscrit=1, class={"전사"}, anitype=1},
[10] = {name="격노!", search="격노 효과를 얻었습니다.", r=128/256, g=256/256, b=128/256, iscrit=1, class={"전사"}},
[11] = {name="성전사!", search="신성한 힘 효과를 얻었습니다.", r=128/256, g=128/256, b=256/256, iscrit=1},


--Captured data examples. Remove, change, or comment out the ones you don't want.

--ROGUE and HUNTER Examples
--[12] = {name="반격!", search="당신을 공격했지만 막았습니다.", r=128/256, g=128/256, b=256/256, iscrit=1, class={"도적"}}, 
--[13] = {name="역습!", search="당신을 공격했지만 막았습니다.", r=128/256, g=128/256, b=256/256, iscrit=1, class={"사냥꾼"}}, 
[14] = {name="살쾡이의 이빨!", search="당신을 공격했지만 교묘히 피했습니다.", r=128/256, g=128/256, b=256/256, iscrit=1, class={"사냥꾼"}}, 

--critical hits
[15] = {name="주문 치명타! (*1: *3)", argcount=3, search="(.+)%|1으로;로; (.+)에게 (%d+)의 (.+) 치명상 피해를 입혔습니다.", r=256/256, g=256/256, b=0/256}, 
--[16] = {name="치명타! (*2)", argcount=2, search="(.+)%|1을;를; 공격하여 (.+)의 치명상을 입혔습니다.", r=256/256, g=256/256, b=0/256},

--all your hits
--[17] = {name="*2: *3 (*1)", argcount=3, search="Your (.+) hits (.+) for (%d+)", r=256/256, g=256/256, b=0/256}, 
--[18] = {name="*1: *2", argcount=2, search="You hit (.+) for (%d+)", r=256/256, g=256/256, b=0/256},

--Your DOTS
--You need to uncomment CHAT_MSG_SPELL_PERIODIC_CREATURE_DAMAGE in the section below to see your DOTS against MOBS
--[19] = {name="*1: *2 (*4)", argcount=4, search="(.+) suffers (%d+) (.+) damage from your (.+). %((%d+) resisted%)", r=256/256, g=256/256, b=0/256}, 
--[20] = {name="*1: *2 (*4)", argcount=4, search="(.+) suffers (%d+) (.+) damage from your (.+).", r=256/256, g=256/256, b=0/256}, 

--Spam Stoppers
--[21] = {name="+*1", argcount=1, search="피의 갈증|1으로;로; 생명력이 (%d+)만큼 회복되었습니다.", r=0/256, g=256/256, b=0/256, class={"전사"}},
