...
CT_MMForward_AttachmentsDisabled = nil;
function CT_MMForward_DisableAttachments(disable)
	if ( disable and not CT_MMForwardAttachmentsDisabled) then
		...
		CT_MMForwardAttachmentsDisabled = 1;
		
		elseif ( not disable and CT_MMForwardAttachmentsDisabled ) then
			...
			CT_MMForwardAttachmentsDisabled = nil;
	end
end
